...
type alias Model =
    ...
    -- describes picked dates condition
    }


type alias RangeCondition =
    { isStartPicked : Bool
    , isFinishPicked : Bool
...
initRangeCondition : RangeCondition
initRangeCondition =
    { isStartPicked = False
...
init =
    ( DatePicker <|
        ...
        , inputText = Nothing
        , today = initDate
        , rangeCondition = initRangeCondition
        }
...
update settings msg (DatePicker ({ forceOpen, focused, rangeCondition } as model)) =
    case msg of
        CurrentDate date ->
